...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Producto.cantidad'
        db.alter_column('bodega_producto', 'cantidad', self.gf('django.db.models.fields.IntegerField')(max_length=1000))


    def backwards(self, orm):
        
        # Changing field 'Producto.cantidad'
        db.alter_column('bodega_producto', 'cantidad', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'bodega.producto': {
            ...
            'cantidad': ('django.db.models.fields.IntegerField', [], {'max_length': '1000'}),
